...
class NaiveBayesClassifier:
    ...
    def __init__(self, test_size=0.25, random_state=42, model=None, stratify=True):
        ...
        # swap to MultinomialNB or BernoulliNB if needed
...
if __name__ == '__main__':
    ...
    own_classifier = NaiveBayesClassifier(test_size=0.25, random_state=42, model=MultinomialNB() ,stratify=True) # Configurable parameters
